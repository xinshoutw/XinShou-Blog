...
> 已經下載的同名檔案將被忽略
> 此腳本無法判斷檔案是否有更新，請將目錄完全刪除再重新運行腳本

{{< spoiler "Demo Images" >}}
![Demo1](/posts/Tools/爬下你的%20http-server%20目錄/Demo1.png)
![Demo2](/posts/Tools/爬下你的%20http-server%20目錄/Demo2.png)
{{< /spoiler >}}
